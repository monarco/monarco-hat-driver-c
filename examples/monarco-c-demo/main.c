...
void sdc_init()
{
    ...
    cxt.sdc_items[SDC_FIXED_RS485BAUD] = (monarco_sdc_item_t){ .address = 0x010, .value = 384, .request = 1 };
    cxt.sdc_items[SDC_FIXED_RS485MODE] = (monarco_sdc_item_t){ .address = 0x011, .value = MONARCO_SDC_RS485_DEFAULT_MODE, .request = 1 };
